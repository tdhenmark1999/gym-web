                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{ old('category',$parameter->category) }}" name="category" id="category">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input readonly class="form-control" type="text" value="{{ old('title',$parameter->value) }}" name="value" id="title">
