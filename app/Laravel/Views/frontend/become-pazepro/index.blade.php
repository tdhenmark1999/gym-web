                                        ...
                                        <form class="c-form" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 {{$errors->first('description') ? 'has-error' : NULL}}">
                                                    ...
                                                    <label>Front Image <span class="red-require">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <label>Back Image <span class="red-require">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                <label>Primary ID Type <span class="red-require">*</span></label>
                                                    <select name="first_id_type">
                                                        <option value="" >Select PRIMARY ID Type</option>
                                                        @foreach ($parameter_primary_id as $item)
                                                ...
                                                <div class="col-lg-6">
                                                <label>Primary ID Number <span class="red-require">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                <label>Secondary ID Number <span class="red-require">*</span></label>
                                                    <select name="second_id_type">
                                                        <option value="">Select Secondary ID Type</option>  
                                                        @foreach ($parameter_secondary_id as $item)
                                                        <option value="{{ $item->value }}"> {{ $item->title }} </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-lg-12">
                                                     <label>Description about you <span class="red-require">*</span></label>
                                            ...
                                            <div class="col-lg-12">
                                                 <label>Sports <span class="red-require">*</span></label>
                                                    <select name="sport[]" id="sport" style="" multiple="">
                                                        @foreach ($parameter_sports as $item)
                                                        <option value="{{ $item->value }}"> {{ $item->title }} </option>
                                                        @endforeach
                                                ...
                                                --}}
                                                <div class="col-md-12">
                                                    <span class="create-post">Curriculum Vitae <span class="red-require">*</span></span>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="container1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="month" class="mt-1" placeholder="Month" name="month[]" />
                                                            </div>
                                                            <!-- <div class="col-md-4">
...
<script type="text/javascript">
          $(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                if (x < max_fields) {
                    x++;
                    $(wrapper).append('<div class="row"><div class="col-md-4"><input type="text" class="mt-1" placeholder="Title" name="title[]"/></div><div class="col-md-4"><input type="text" class="mt-1" placeholder="Location" name="location[]"/></div><div class="col-md-4"><input type="month" class="mt-1" placeholder="Month" name="month[]"/></div><div class="col-md-4"><input type="file" class="mt-1" placeholder="File" name="certificate_file[]"/></div><a href="#" class="delete btn bg-danger mt-md-3" style="color: white;height: 41px; margin-left: 10px;"><i class="fa fa-trash"></i></a></div>'); //add input box
                } else {
