...
class BecomePazeproController extends Controller{
	...
	public function index(){
		...
		$this->data['parameter_sports'] = $this->parameters_model->where('category','sports')->get();
		$this->data['parameter_primary_id'] = $this->parameters_model->where('category','primary_id')->get();
		$this->data['parameter_secondary_id'] = $this->parameters_model->where('category','secondary_id')->get();
